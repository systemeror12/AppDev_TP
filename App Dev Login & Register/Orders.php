    ...
    <div class="container">
        ...
        <?php
           ...
           while($row = mysqli_fetch_assoc($result)) {
               ...
               echo '<a href="Claimed.php?claimedid='.$id.'">Claim</a>';
               echo '<a href="#">Print</a>';
               echo '<a href="DeleteOrder.php?deleteid='.$id.'">Delete</a>';
               echo "</span>";
               echo "</td>"; 
               echo "</tr>";
               echo "</tbody>";
           ...
           echo "</table>";
           echo " </div >";
           echo ' <span class="add"><a href="OrderArchive.php">Archive</a></span>';
           } else {
